...
namespace SingleAndSingleOrDefault
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            new Employee() { Id=102, Name="chunky", City="Delhi"},
            new Employee() { Id=103, Name="chandrika", City="Indore"},
            new Employee() { Id=104, Name="hemamala", City="Madras"},
            new Employee() { Id=105, Name="Hema", City="Pune"}
        };
            var res = employeeList.Single(e => e.Id == 102);
            var res1 = employeeList.Single(e => e.Name == "hemamala");
            IList<int> intList = new List<int> { 2 };
            var res2 = intList.Single();
            var res3 = employeeList.SingleOrDefault(e => e.Name == "chunky");
